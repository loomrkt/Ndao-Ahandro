                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      <input
                        ...
                        className="peer p-4 block w-full bg-base-100 border-transparent rounded-lg text-sm  placeholder:text-transparent focus:outline-none focus:ring-0 focus:border-transparent disabled:opacity-50 disabled:pointer-events-none
              focus:pt-6
              focus:pb-2
              ...
              <div className="space-y-14">
                ...
                <div className="flex gap-x-5">
                  ...
                  <div className="grow">
                    ...
                    <p className="mt-2">
                      <a
                        className="group inline-flex items-center gap-x-2 font-medium text-sm text-primary decoration-2 hover:underline focus:outline-none focus:underline"
                        href="#"
                      >
                        Job openings
                        <svg
                          className="shrink-0 size-4 transition group-hover:translate-x-0.5 group-focus:translate-x-0"
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
