function Gallery() {
    return ( <>
<div className="grid grid-cols-2 sm:grid-cols-4 gap-2 my-20">
  {[
    ...
    "https://images.unsplash.com/photo-1669824774762-65ddf29bee56?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=560&q=80",
    ...
    <img
      key={index}
      className={`w-full size-40 object-cover ${index >= 6 ? "hidden sm:block" : ""}`}
      src={src}
      alt="Gallery Image"
    />
  ))}
