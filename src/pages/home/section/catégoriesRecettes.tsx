...
function CatégoriesRecettes() {
    ...
    <div className="p-6 py-20 w-full">
            <div className="text-center md:max-w-[600px] mx-auto">
                <h2 className="text-3xl">Voici les catégories de recettes</h2>
                <p className="mt-4 dark:text-red-600 text-sm text-wp">Trouvez l’inspiration culinaire en explorant nos recettes variées! De quoi ravir tous les gourmands!</p>
            </div>
